...
.st-emotion-cache-1nm7f8b:hover {{ background-color: var(--button-hover) !important; }}
.st-emotion-cache-pkpr8m p {{ color: var(--text-dark) !important; }}
.st-emotion-cache-pkpr8m:hover {{ background-color: var(--border-light) !important; border-radius: 8px; }}
...
/* --- BUTONLAR --- */
.stButton > button {{
    background-color: var(--primary-green); color: white; border-radius: 8px;
    border: none; padding: 0.7rem 1.2rem; font-weight: 600;
