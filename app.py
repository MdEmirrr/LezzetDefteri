...
# --- SABİT DEĞİŞKENLER ---
TUM_KATEGORILER = sorted(["Aperatif", "Atıştırmalık", "Bakliyat", "Balık vs", "Çorba", "Dolma", "Et", "Glutensiz", "Hamurişi", "Kahvaltılık", "Kebap", "Kızartma", "Köfte", "Makarna", "Meze", "Pilav", "Pratik", "Salata", "Sandviç", "Sebze",  "Sos",  "Tatlı", "Tavuk", "Pizza", "İçecek", ])
