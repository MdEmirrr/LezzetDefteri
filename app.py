...
# --- SABİT DEĞİŞKENLER ---
TUM_KATEGORILER = sorted(["Aperatif", "Atıştırmalık", "Bakliyat", "Balık & Deniz Ürünleri", "Çorba", "Dolma", "Et", "Glutensiz", "Hamurişi", "Kahvaltılık", "Kebap", "Kızartma", "Köfte", "Makarna", "Meze", "Pilav", "Pratik", "Salata", "Sandviç", "Sebze",  "Sos",  "Tatlı", "Tavuk", "Pizza", "İçecek", "Tavuklu Yemek", "Etli Yemek" ])
